...
TASKS_CONFIG = {
    'cuisine': [
        ...
        },
        {
            ...
            'description': 'on est pas à Buckingham, fais simple… fourchette à gauche, couteau à droite',
            'points': 3,
        ...
        },
        {
            ...
            'description': 'ça ira pour cette fois !',
            'points': 4,
        ...
        },
        {
            ...
            'description': 'ça arrive même aux meilleurs !',
            'points': -3,
    ...
    'buanderie': [
        {
            ...
            'description': 't\'as regardé dans les poches de ton pantalon ?',
            'points': 4,
        ...
        },
        {
            ...
            'description': 't\'es pas obligé d\'attendre devant !',
            'points': 3,
        ...
        },
        {
            ...
            'description': 'c\'est la pire tâche !',
            'points': 4,
    ...
    'toilettes': [
        ...
        },
        {
            ...
            'description': 'ou, encore plus simple, fais pipi assis !',
            'points': 1,
        ...
        },
        {
            ...
            'description': 'faut reconnaître, c\'est le meilleur endroit pour échapper aux corvées !',
            'points': -3,
    ...
    'salon': [
        ...
        },
        {
            ...
            'description': 'en musique évidemment !',
            'points': 5,
    ...
    'chambre_parentale': [
        ...
        },
        {
            ...
            'description': 'mets-les au moins sur une chaise, comme tout le monde',
            'points': 3,
    ...
    'salle_bain': [
        {
            ...
            'description': '3 minutes, 3 minutes… 30 secondes c\'est déjà bien !',
            'points': 1,
        ...
        },
        {
            ...
            'description': 'c\'est pourtant pas compliqué !',
            'points': 1,
        ...
        },
        {
            ...
            'description': 'franchement, ça t\'évitera des réflexions !',
            'points': 2,
    ...
    'chambre_garcon': [
        {
            'name': 'Faire son lit',
            'image': 'chambre ados/faire son lit.webp',
            'description': 'tire ta couette et gagne 3 points !',
            'points': 3,
        ...
        },
        {
            'name': 'Ranger sa chambre',
            'image': 'chambre ados/Ranger sa chambre.webp',
            'description': 'tu retrouveras LE truc que t\'as perdu !',
            'points': 4,
        ...
        },
        {
            'name': 'Aérer sa chambre',
            'image': 'chambre ados/aérer sa chambre.webp',
            'description': 'pour avoir l\'air frais !',
            'points': 2,
        ...
        },
        {
            'name': 'Vider sa corbeille',
            'image': 'chambre ados/vider sa corbeille à papier.webp',
            'description': 'avant qu\'elle déborde !',
            'points': 2,
    ...
    'chambre_enfant': [
        {
            ...
            'description': 'eux aussi ont besoin de repos !',
            'points': 4,
        ...
        },
        {
            ...
            'description': 'ça t\'empêchera pas de jouer à la console après !',
            'points': 3,
    ...
    'chambre_bebe': [
        {
            ...
            'description': 'au sein ça compte aussi !',
            'points': 5,
        ...
        },
        {
            ...
            'description': 'c\'est parti pour 3 ans !',
            'points': 4,
        ...
        },
        {
            ...
            'description': 'il peut pas encore le faire !',
            'points': 4,
    ...
    'garage': [
        {
            ...
            'description': 'c\'est quand même un peu kiffant',
            'points': 5,
...
def menu():
    ...
    ALL_DEFAULT_ROOMS = [
        ...
        {'key': 'chambre_parentale', 'name': 'Chambre 1',    'image': 'images/imageqfq/105- Furniture Clipart.png', 'category': 'chambre_parentale', 'fixed': False},
        ...
        {'key': 'cuisine',  'name': 'Cuisine',      'image': 'images/imageqfq/Stove-Top-Oven-Clipart-6.png',  'category': 'cuisine',    'fixed': True},
        {'key': 'salon',    'name': 'Salon',        'image': 'images/imageqfq/68- Furniture Clipart.png',  'category': 'salon',      'fixed': True},
        {'key': 'bureau',   'name': 'Bureau',       'image': 'images/imageqfq/78- Furniture Clipart.png',       'category': 'piece_bonus', 'fixed': True},
        {'key': 'salle_bain','name': 'Salle de bain','image': 'images/imageqfq/88 - Bath Essentials.png',     'category': 'salle_bain', 'fixed': True},
        {'key': 'toilettes','name': 'Toilettes',    'image': 'images/thumbs/Wc2.webp',          'category': 'wc',         'fixed': True},
        {'key': 'buanderie','name': 'Buanderie',    'image': 'images/imageqfq/Dish-Washer-Washing-Machine-Clipart4.png',   'category': 'buanderie',  'fixed': True},
        {'key': 'garage',   'name': 'Garage',       'image': 'images/imageqfq/95 - Man Cave.png',      'category': 'garage',     'fixed': False},
    ]
    if house_id:
