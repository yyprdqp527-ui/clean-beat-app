...
def baby_tracking(cat, task_id):
    ...
    from app import _dbg, normalize_category, TASKS_CONFIG, get_db_connection
...
def save_baby_tracking():
    ...
    from app import (_dbg, get_db_connection, now_paris,
                     mark_message_as_read, safe_socketio_emit,
                     SOCKETIO_AVAILABLE, socketio)
