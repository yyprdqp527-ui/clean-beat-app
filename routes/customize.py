...
def personnaliser_maison():
    ...
    ALL_ROOMS = [
        {'key': 'chambre_parentale', 'default_name': 'Chambre 1',     'image': 'images/imageqfq/105- Furniture Clipart.webp', 'fixed': False},
        ...
        {'key': 'salle_bain',        'default_name': 'Salle de bain', 'image': 'images/imageqfq/88 - Bath Essentials.webp',                'fixed': False},
        {'key': 'toilettes',         'default_name': 'Toilettes',     'image': 'images/thumbs/Wc2.webp',                    'fixed': False},
        {'key': 'buanderie',         'default_name': 'Buanderie',     'image': 'images/imageqfq/Dish-Washer-Washing-Machine-Clipart4.webp',              'fixed': False},
        {'key': 'garage',            'default_name': 'Garage',        'image': 'images/imageqfq/95 - Man Cave.webp',                'fixed': False},
    ]
